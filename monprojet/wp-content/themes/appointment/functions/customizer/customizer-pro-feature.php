...
class Appointment_Pro__Feature_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    <a target="_blank" href="<?php echo esc_url('https://webriti.com/appointment/');?>" class="appointment-pro-button button-primary"><?php esc_html_e( 'UPGRADE TO PRO','appointment' ); ?></a>
    <hr>
</div>
    <?php
    }
